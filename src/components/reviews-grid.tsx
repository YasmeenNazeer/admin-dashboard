...
const mockReviews = [
  {
    ...
    customer: "John Doe",
    rating: 5,
    comment: "I loved how easy it was to find and book a car. The website is super user-friendly, and the search bar helped me find exactly what I needed in seconds.",
    product: "Hacthback",
    date: "2024-03-15",
  },
  {
    ...
    customer: "Jane Smith",
    rating: 4,
    comment: "I booked a luxury sedan for my trip, and the entire process was smooth.",
    product: "Electric",
    date: "2024-03-14",
  },
  {
    ...
    rating: 2,
    comment: "I travel a lot for work, and this website has been a lifesaver. ",
    product: "SUV",
    date: "2024-03-13",
  },
  {
  ...
  },
  {
    ...
    customer: "Alex Chen",
    rating: 3,
    comment: "The best car rental experience Ive ever had.",
    product: "Sports",
    date: "2024-03-11",
  },
]
